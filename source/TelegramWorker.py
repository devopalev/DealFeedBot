...
from telegram.ext import Updater, MessageHandler, Filters, PicklePersistence, CallbackContext, Defaults
...
def run():
    ...
    conf = Defaults(timeout=15)
    updater = Updater(creds.TG_BOT_TOKEN, persistence=storage, defaults=conf)
